...
public class University {
    ...
    public void updateFrom(University university) {
        ...
        if (university.appYears != null) {
            appYears = university.appYears;
        }
        if (university.winYears != null) {
            winYears = university.winYears;
        }
        if (university.goldYears != null) {
            goldYears = university.goldYears;
        }
        if (university.silverYears != null) {
            silverYears = university.silverYears;
        }
        if (university.bronzeYears != null) {
            bronzeYears = university.bronzeYears;
        }
        if (university.regYears != null) {
            regYears = university.regYears;
        }
    }
}
